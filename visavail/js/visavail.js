	function visavailChart(customXTicks) {
		
	  var customXTicks = customXTicks || null;
	  ...
	  function chart(selection) {
	    selection.each(function drawGraph(dataset) {
	      ...
	      if(customXTicks != null){
	    	  xScaleTicks = xScale.ticks(24);
	      }
	      
	      // create vertical grid
	      svg.select('#g_axis').selectAll('line.vert_grid')
	      	  .data(xScaleTicks)
	          .enter()
	          .append('line')
	          .attr({
